...
const CartItem = ({product}: CartItemProps) => {
  ...
  const handleDecraseProductQuantityClick = () => {
      ...
      <div className="flex items-center gap-4">
        <div className="bg-accent flex items-center justify-center rounded-lg h-[77px] w-[77px]">
          <Image 
            ...
            sizes="100vw"
            alt={product.name}
            className="w-auto max-w-[80%] max-h-[70%] h-auto"
          />
        </div>
        ...
        <div className="flex flex-col">
          ...
          <div className="flex items-center gap-1">
            <Button size="icon" variant="outline" className="h-8 w-8" onClick={handleDecraseProductQuantityClick}>
